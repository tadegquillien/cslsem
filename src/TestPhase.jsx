...
const TestPhase = (props) => {
    ...
    const img = <Image
        ...
        Etext='E' Atext='A' Btext='B' Ctext="C"
        Acolor={Acolor} Bcolor={Bcolor} Ccolor={Ccolor} Ecolor={Ecolor} r={r}
        AState={AState} BState={BState} CState={CState} EState={EState} mode={props.mode} use={'normal'} />;
    ...
    const focalLetter = BWired ? 'B' :
        (CWired ? 'C' : 'A');
    const focalColor = BWired ? Bcolor : (
        (CWired ? Ccolor : Acolor)
    )
